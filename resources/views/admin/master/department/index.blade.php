						...
						@foreach($master as $list)
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-primary btn-sm" href="{{route('setting.masters.departments.edit', $list->id)}}">Edit</a>
									<a class="btn btn-danger btn-sm" href="{{route('setting.masters.departments.destroy', $list->id)}}">Delete</a>
								</td>
...
{{--MODAL FOR CREATING--}}
<form action="{{route('setting.masters.departments.store')}}" method="post">	
	{{csrf_field()}}	
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					@include('admin.master.department.create')
				</div>

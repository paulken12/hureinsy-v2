...
@if(!empty($get_job_details->proposed_remarks_hr))
	...
	<div class="row">
		...
		<div class="col">
			<div class="form-group">
				<input type="text" id="proposed_remarks_job_exec" name="proposed_remarks_job_exec" class="form-control" title="proposed_remarks_job_exec" value="{{$get_job_details->proposed_remarks_exec}}">
			</div>
		</div>
	</div>
@endif
                ...
                <div class="layer w-100 p-20">
                    <div class="peers">
                        <div class="peer peer-greed">
                            <small class="lh-1">My Paf Request</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button v-if="showa" type="submit" class="btn btn-success">Confirm</button>
    ...
    export default {
        ...
        methods: {
            ...
            submit(){
                ...
                toast.text("Paf Successfully confirmed.").goAway(5000);
                $("#Modal").modal('hide');
                this.form.patch('/paf/my_request/list/show/store/'+this.form.paf_id);
                this.paf_info[this.form.index].show = 1;
            },

                ...
                <div class="layer w-100 p-20">
                    <div class="peers">
                        <div class="peer peer-greed">
                            <small class="lh-1">PAF for Assessment</small>
                        </div>
                    </div>
                </div>
                <table id="empSched-list" class="table table-striped table-gray" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr v-for="(paf, index) in paf_info">
                            ...
                            <td><small>{{paf.company_id}} - {{paf.name}}</small></td>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <small v-text="form.date_effective"></small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row alert alert-info">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <small v-else v-text="form.a_remarks"></small>
                                                    <br>
                                                    <small class="text-primary">Executive remarks:</small>
                                                    <small v-text="getPaf.ea"></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row alert alert-info">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <small v-else v-text="form.b_remarks"></small>
                                                    <br>
                                                    <small class="text-primary">Executive remarks:</small>
                                                    <small v-text="getPaf.eb"></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row alert alert-info">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    ...
                                                    <small v-else v-text="form.c_remarks"></small>
                                                    <br>
                                                    <small class="text-primary">Executive remarks:</small>
                                                    <small v-text="getPaf.ec"></small>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="nav-hr" role="tabpanel" aria-labelledby="nav-hr-tab">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <select v-model="form.h_be" :disabled="!showa" id="Behavior" class="custom-select">
                                                        <option value="" selected hidden>--Select--</option>
                                                        <option v-for="(beh, index) in beha" :value="beh.key" >{{ beh.behaviour }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <select v-model="form.h_pr" :disabled="!showa" id="Proficiency" class="custom-select">
                                                        <option value="" selected hidden>--Select--</option>
                                                        <option v-for="(pro, index) in prof" :value="pro.key" >{{ pro.proficiency }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <select v-model="form.h_ov" :disabled="!showa" id="Overall" class="custom-select">
                                                        <option value="" selected hidden>--Select--</option>
                                                        <option v-for="(ove, index) in over" :value="ove.key" >{{ ove.overall }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <select v-model="form.h_pe" :disabled="!showa" id="Performance" class="custom-select">
                                                        <option value="" selected hidden>--Select--</option>
                                                        <option v-for="(per, index) in perf" :value="per.key" >{{ per.evaluation }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <input v-model="form.h_re" :disabled="!showa" class="form-control" type="text" placeholder="HR Remarks">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div v-if="showa" class="modal-footer">
                                <button type="submit" @click="dec = 1" class="btn btn-primary">Escalate to Executive</button>
                                <button type="submit" @click="dec = 2" class="btn btn-secondary">Return to Manager</button>
...
<script>
    ...
    export default {
        props: ['employees', 'list', 'cchange', 'substatus', 'beha', 'prof', 'over', 'perf'],
        ...
        methods: {
            ...
            getContract(index){
                ...
                this.form.date_effective = this.paf_info[index].date_effective;
                ...
                this.showa = this.paf_info[index].show == '1' ? true : false;
                $("#Modal").modal('show');
            ...
            validate(){
                ...
                if(!this.form.h_be){
                    this.error_msg.push('Behavioural Assessment is required.');
                }
                if(!this.form.h_pr){
                    this.error_msg.push('Proficiency Test is required.');
                }
                if(!this.form.h_ov){
                    this.error_msg.push('Overall Recommendation is required.');
                }
                if(!this.form.h_pe){
                    this.error_msg.push('Performance Evaluation is required.');
                }
                if(!this.form.h_re){
                    this.error_msg.push('HR remarks is required.');
                }
                if((this.getPaf.job_description != 'No Job' || this.getPaf.department != 'No Department' || this.getPaf.team != 'No Team' || this.getPaf.reporting_to != 'No Reporting To' || this.getPaf.project != 'No Project') && !this.form.a_remarks){
                    this.error_msg.push('You need to put remarks on annex A.');
                }
                if((this.getPaf.company != 'No Work Location' || this.getPaf.schedule_type != 'No Schedule') && !this.form.b_remarks){
                    this.error_msg.push('You need to put remarks on annex B.');
                }
                if((this.getPaf.job_grade != 'No Job Grade' || this.getPaf.probationary_rate != 'No Probationary Rate' || this.getPaf.gross_salary != 'No Gross Salary' || this.getPaf.basic_salary != 'No Basic Salary' || this.getPaf.other_bonus_allowance != 'No Allowance'|| this.getPaf.other_benefits != 'No Benefits') && !this.form.c_remarks){
            ...
            submit(){
                ...
                if(!this.isError){
                    ...
                    if(this.dec == 1){
                        this.form.status = 1;
                        this.form.substatus = 2; 
                        toast.text("Request successfuly sent to executive.").goAway(5000);
                    }else if(this.dec == 2){
                        this.form.status = 1;
                        this.form.substatus = 3;
                        toast.text("Request successfuly returned to manager.").goAway(5000);
                    }else{
                        this.form.status = 2;
                        this.form.substatus = 4;
                        toast.text("Request successfuly unauthorize.").goAway(5000);
                    }
                    this.getSubStat(this.form.index);
                    $("#Modal").modal('hide');
                    this.form.patch('/paf/assessment/list/show/store/'+this.form.paf_id);
                    this.resetForm();
                }
            },
            ...
            reqContract(id){
                axios.get('/paf/assessment/list/show/'+id)
                    .then(response => {
                        this.getPaf = response.data.data;

                        this.form.a_remarks = response.data.data.a;
                        this.form.b_remarks = response.data.data.b;
                        this.form.c_remarks = response.data.data.c;
                        this.form.h_be = response.data.data.beh;
                        this.form.h_pr = response.data.data.pro;
                        this.form.h_ov = response.data.data.ove;
                        this.form.h_pe = response.data.data.per;
                        this.form.h_re = response.data.data.rem;
                    })
                    .catch(error => {

                ...
                <table id="empSched-list" class="table table-striped table-gray" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        <tr v-for="(tv, index) in TV">
                            ...
                            <td><button class="btn btn-link" data-toggle="modal" @click="openModal(tv, index)" data-target="#Info">more...</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="TV">Requested Time Validation by {{imodal.name}}</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <small class="text-primary">Alibi/Proof presented</small>
                                <p>{{imodal.reason}}</p>
                            </div>
                        </div>
                        <div class="row">
        ...
        methods: {
            ...
            submit(index, flag){
                if(this.form.remarks){
                    $("#Info").modal('hide');
                    this.err_msg = "";
                    for(let x = 0; x < this.TV.length; x++){
                        if(this.TV[x].id == index){
                            if(flag == 1){
                                this.form.oth = flag;
                                this.TV[x].status = "Authorized";
                                break;
                            }else{
                                this.form.oth = flag;
                                this.TV[x].status = "Unauthorized";
                                break;
                            }
                        }
                    }
                    this.form.patch('/authorize/forms/tv/' + index);
